---
title: "Managing and Tracking Candidates in the ATS Platform"
sidebarTitle: "Candidates"
description: "Learn how to add, track, and manage candidates in the ATS Platform using list view, Kanban board, bulk actions, and saved filter views."
---
